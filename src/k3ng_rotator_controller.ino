...
void change_tracking(byte action){
  ...
  // no-op: moon/sun/satellite tracking are not part of this fork's active feature set.
  // Kept as a stub since it's called unconditionally from active azimuth-only code paths.
