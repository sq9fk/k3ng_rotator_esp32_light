...
// rotary encoder pins and options
  ...
  #define az_position_pulse_pin 0                       // TODO: set to the actual GPIO your AZ pulse sensor is wired to (any Nano ESP32 GPIO works with attachInterrupt/digitalPinToInterrupt)
#endif

#ifdef FEATURE_EL_POSITION_PULSE_INPUT
  #define el_position_pulse_pin 1                       // TODO: set to the actual GPIO your EL pulse sensor is wired to
...
// TODO: these pin numbers are carried over from the original AVR-based pinout and have not been
// re-verified against the Arduino Nano ESP32's pin mapping/pinout diagram - confirm before wiring.
