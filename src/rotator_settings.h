...
#define WIFI_SSID "CHANGE_ME"          // <-set to your WiFi network name
#define WIFI_PASSWORD "CHANGE_ME"      // <-set to your WiFi password
#define WIFI_TCP_PORT 4533             // control port, reachable via e.g. rotctl/rotctld over TCP
#define WIFI_CONNECT_TIMEOUT_MS 15000  // how long to wait for WiFi.begin() to connect at boot before giving up
#define WIFI_MESSAGE_TIMEOUT_MS 5000   // discard a partially-received command after this long
